...
let ExampleGeminiLive = (() => {
    ...
    var ExampleGeminiLive = _classThis = class extends _classSuper {
        ...
        onAwake() {
            // Initialize logger
            this.logger = new Logger_1.Logger("ExampleGeminiLive", this.enableLogging || this.enableLoggingLifecycle, true);
        ...
        createGeminiLiveSession() {
            const GeminiLive = GoogleGenAI_1.Gemini.liveConnect();
