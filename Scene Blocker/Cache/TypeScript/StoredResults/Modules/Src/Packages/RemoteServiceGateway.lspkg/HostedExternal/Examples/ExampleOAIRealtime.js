...
let ExampleOAIRealtime = (() => {
    ...
    var ExampleOAIRealtime = _classThis = class extends _classSuper {
        ...
        onAwake() {
            // Initialize logger
            this.logger = new Logger_1.Logger("ExampleOAIRealtime", this.enableLogging || this.enableLoggingLifecycle, true);
        ...
        connectToWebsocket() {
            const OAIRealtime = OpenAI_1.OpenAI.createRealtimeSession({
