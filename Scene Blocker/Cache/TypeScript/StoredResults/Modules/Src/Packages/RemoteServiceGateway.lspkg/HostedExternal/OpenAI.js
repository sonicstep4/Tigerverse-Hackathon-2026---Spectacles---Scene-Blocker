...
class OpenAI {
    ...
    static chatCompletions(gptRequest) {
        return new Promise((resolve, reject) => {
            ...
            const apiToken = RemoteServiceGatewayCredentials_1.RemoteServiceGatewayCredentials.getApiToken(RemoteServiceGatewayCredentials_1.AvaliableApiTypes.OpenAI);
