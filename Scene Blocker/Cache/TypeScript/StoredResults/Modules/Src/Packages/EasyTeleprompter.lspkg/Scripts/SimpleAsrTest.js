...
exports.SimpleAsrTest = void 0;
var __selfType = requireType("./SimpleAsrTest");
...
let SimpleAsrTest = (() => {
    ...
    var SimpleAsrTest = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("SimpleAsrTest", this.enableLogging || this.enableLoggingLifecycle, true);
    ...
    __setFunctionName(_classThis, "SimpleAsrTest");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        SimpleAsrTest = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SimpleAsrTest = _classThis;
})();
exports.SimpleAsrTest = SimpleAsrTest;
//# sourceMappingURL=SimpleAsrTest.js.map