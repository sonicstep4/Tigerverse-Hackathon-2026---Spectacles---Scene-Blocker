...
let StageCalibrationController = (() => {
    ...
    var StageCalibrationController = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.useCameraRelativeY = this.useCameraRelativeY;
            this.cameraRelativeYOffset = this.cameraRelativeYOffset;
        ...
        calibrateNow() {
            ...
            if (this.debugLogs) {
                print("StageCalibrationController: Stage recalibrated at (" +
