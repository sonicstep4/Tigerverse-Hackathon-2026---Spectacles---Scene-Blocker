...
class Gemini {
    ...
    static models(geminiRequest) {
        return new Promise((resolve, reject) => {
            ...
            const apiToken = RemoteServiceGatewayCredentials_1.RemoteServiceGatewayCredentials.getApiToken(RemoteServiceGatewayCredentials_1.AvaliableApiTypes.Google);
