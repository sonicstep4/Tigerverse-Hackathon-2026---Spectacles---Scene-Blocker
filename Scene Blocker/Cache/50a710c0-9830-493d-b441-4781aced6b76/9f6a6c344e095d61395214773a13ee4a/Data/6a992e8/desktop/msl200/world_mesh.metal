...
//float Port_Input1_N017 4384
//float Port_Multiplier_N022 4416
//float2 Port_Scale_N013 4448
//float2 Port_Scale_N015 4456
//float2 Port_Scale_N020 4464
//float Port_Input1_N000 4472
//float Port_Input1_N029 4476
//float Port_Input1_N003 4480
//float Port_Input1_N056 4484
//float Port_Input1_N055 4488
//float4 Port_Value_N023 4496
//float Port_Input1_N010 4512
//float Port_Input0_N062 4516
//float Port_Input1_N059 4520
//float Port_Input1_N061 4524
//float Port_Input2_N061 4528
//float Port_Input1_N019 4532
//float Port_Input1_N049 4536
//float Port_Input2_N049 4540
//float depthRef 4544
//}
...
if ((*sc_set0.UserUniforms).sc_RayTracingCasterConfiguration.x!=0u)
{
param_1=sc_RayTracingCalculateCasterFaceNormal(gl_FragCoord,(*sc_set0.UserUniforms),(*sc_set0.sc_RayTracingCasterVertexBuffer),(*sc_set0.sc_RayTracingCasterNonAnimatedVertexBuffer),(*sc_set0.sc_RayTracingCasterIndexBuffer),sc_set0.sc_RayTracingHitCasterIdAndBarycentric,sc_set0.sc_RayTracingHitCasterIdAndBarycentricSmpSC);
}
else
{
float3 l9_1=param_2.SurfacePosition_WorldSpace;
float3 l9_2=float3(dfdx(l9_1.x),dfdx(l9_1.y),dfdx(l9_1.z));
float3 l9_3=float3(dfdy(l9_1.x),dfdy(l9_1.y),dfdy(l9_1.z));
param_1=cross(l9_2,l9_3);
param_1/=float3(length(param_1));
}
Normal_N48=param_1;
...
int l9_5=l9_4;
Camera_Right_N51=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_5][0].xyz);
...
int l9_7=l9_6;
Camera_Up_N64=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_7][1].xyz);
...
if ((*sc_set0.UserUniforms).sc_RayTracingCasterConfiguration.x!=0u)
{
param_3=sc_RayTracingCalculateCasterFaceNormal(gl_FragCoord,(*sc_set0.UserUniforms),(*sc_set0.sc_RayTracingCasterVertexBuffer),(*sc_set0.sc_RayTracingCasterNonAnimatedVertexBuffer),(*sc_set0.sc_RayTracingCasterIndexBuffer),sc_set0.sc_RayTracingHitCasterIdAndBarycentric,sc_set0.sc_RayTracingHitCasterIdAndBarycentricSmpSC);
}
else
{
float3 l9_8=param_4.SurfacePosition_WorldSpace;
float3 l9_9=float3(dfdx(l9_8.x),dfdx(l9_8.y),dfdx(l9_8.z));
float3 l9_10=float3(dfdy(l9_8.x),dfdy(l9_8.y),dfdy(l9_8.z));
param_3=cross(l9_9,l9_10);
param_3/=float3(length(param_3));
}
Normal_N69=param_3;
...
float3 param_5=Output_N27;
float l9_11=dot(param_5,param_5);
float l9_12;
if (l9_11>0.0)
{
...
{
l9_14=pow(Output_N30,(*sc_set0.UserUniforms).Port_Input1_N003);
}
Output_N3=l9_14;
...
int l9_16=l9_15;
Camera_Up_N47=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_16][1].xyz);
float3 Normal_N26=float3(0.0);
ssGlobals param_8=Globals;
float3 param_7;
if ((*sc_set0.UserUniforms).sc_RayTracingCasterConfiguration.x!=0u)
{
param_7=sc_RayTracingCalculateCasterFaceNormal(gl_FragCoord,(*sc_set0.UserUniforms),(*sc_set0.sc_RayTracingCasterVertexBuffer),(*sc_set0.sc_RayTracingCasterNonAnimatedVertexBuffer),(*sc_set0.sc_RayTracingCasterIndexBuffer),sc_set0.sc_RayTracingHitCasterIdAndBarycentric,sc_set0.sc_RayTracingHitCasterIdAndBarycentricSmpSC);
}
else
{
float3 l9_17=param_8.SurfacePosition_WorldSpace;
float3 l9_18=float3(dfdx(l9_17.x),dfdx(l9_17.y),dfdx(l9_17.z));
float3 l9_19=float3(dfdy(l9_17.x),dfdy(l9_17.y),dfdy(l9_17.z));
param_7=cross(l9_18,l9_19);
param_7/=float3(length(param_7));
}
Normal_N26=param_7;
...
{
l9_20=pow(Output_N52,(*sc_set0.UserUniforms).Port_Input1_N056);
}
Output_N56=l9_20;
...
float2 l9_22=floor(mod(l9_21.xy,float2(4.0)));
float l9_23=(mod(dot(l9_22,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_9<l9_23)
{
discard_fragment();
}
...
float4 l9_24=fast::max(param_10,float4(0.0));
float4 param_11=l9_24;
if (sc_ShaderCacheConstant_tmp!=0)
{
