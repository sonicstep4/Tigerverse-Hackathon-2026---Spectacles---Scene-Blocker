...
//float Thickness 4384
//float3 Port_Value1_N003 4400
//float2 Port_Import_N142 4424
//float Port_Import_N141 4432
//float2 Port_Import_N139 4440
//float Port_Input1_N005 4448
//float Port_RangeMinA_N010 4452
//float Port_RangeMaxA_N010 4456
//float Port_RangeMinB_N010 4460
//float Port_RangeMaxB_N010 4464
//float depthRef 4468
//}
...
float param_1=Value_N140;
float2 param_2=Value_N143;
float2 param_3=Value_N142;
float param_4=Value_N141;
float2 param_5=Value_N139;
float2 param_6=float2(0.0);
N144_Direction=param_1!=0.0;
N144_UV=param_2;
N144_Scale=param_3;
N144_RotationOffset=param_4;
N144_Center=param_5;
float2 l9_1=N144_UV;
float2 l9_2=N144_Scale*2.0;
float2 l9_3=l9_1;
float2 l9_4=l9_2;
float l9_5=N144_RotationOffset;
float2 l9_6=N144_Center;
float l9_7=sin(radians(l9_5));
float l9_8=cos(radians(l9_5));
float2 l9_9=l9_3-l9_6;
float2 l9_10=(float2(dot(float2(l9_8,l9_7),l9_9),dot(float2(-l9_7,l9_8),l9_9))*l9_4)+l9_6;
l9_1=l9_10;
l9_1-=N144_Center;
float l9_11=(l9_1.x*l9_1.x)+(l9_1.y*l9_1.y);
float l9_12;
if (l9_11<=0.0)
{
l9_12=0.0;
...
l9_19=0.0+(((l9_19-(-l9_20))*1.0)/((l9_21-(-l9_22))+1e-06));
}
else
{
...
l9_19=1.0+(((l9_19-(-l9_23))*(-1.0))/((l9_24-(-l9_25))+1e-06));
}
N144_PolarCoordinates=float2(l9_14,l9_19);
param_6=N144_PolarCoordinates;
PolarCoordinates_N144=param_6;
float2 Export_N145=float2(0.0);
Export_N145=PolarCoordinates_N144;
float2 Output_N6=float2(0.0);
Output_N6=float2(1.0)-Export_N145;
float Output_N2=0.0;
Output_N2=Output_N6.x;
float Output_N5=0.0;
Output_N5=float(Output_N2>=(*sc_set0.UserUniforms).Port_Input1_N005);
float Output_N9=0.0;
float param_7=(*sc_set0.UserUniforms).Thickness;
Output_N9=param_7;
float ValueOut_N10=0.0;
ValueOut_N10=(((Output_N9-(*sc_set0.UserUniforms).Port_RangeMinA_N010)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N010-(*sc_set0.UserUniforms).Port_RangeMinA_N010)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N010-(*sc_set0.UserUniforms).Port_RangeMinB_N010))+(*sc_set0.UserUniforms).Port_RangeMinB_N010;
float Output_N8=0.0;
Output_N8=float(Output_N2<=ValueOut_N10);
float Result_N7=0.0;
float l9_26=Output_N5;
bool l9_27=(l9_26*1.0)!=0.0;
bool l9_28;
if (l9_27)
{
l9_28=(Output_N8*1.0)!=0.0;
}
else
{
l9_28=l9_27;
}
Result_N7=float(l9_28);
float4 Value_N3=float4(0.0);
Value_N3=float4((*sc_set0.UserUniforms).Port_Value1_N003.x,(*sc_set0.UserUniforms).Port_Value1_N003.y,(*sc_set0.UserUniforms).Port_Value1_N003.z,Value_N3.w);
Value_N3.w=Result_N7;
FinalColor=Value_N3;
