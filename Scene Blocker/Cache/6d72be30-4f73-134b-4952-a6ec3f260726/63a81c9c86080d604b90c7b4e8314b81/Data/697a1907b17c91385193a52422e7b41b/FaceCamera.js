...
let FaceCamera = (() => {
    ...
    var FaceCamera = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.camera = (__runInitializers(this, _instanceExtraInitializers), this.camera);
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("FaceCamera", this.enableLogging || this.enableLoggingLifecycle, true);
