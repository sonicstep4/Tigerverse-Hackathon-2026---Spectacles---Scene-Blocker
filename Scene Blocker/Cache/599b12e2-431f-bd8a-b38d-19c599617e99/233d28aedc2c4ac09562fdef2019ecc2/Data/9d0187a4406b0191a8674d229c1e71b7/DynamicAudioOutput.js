...
let DynamicAudioOutput = (() => {
    ...
    var DynamicAudioOutput = _classThis = class extends _classSuper {
        ...
        onAwake() {
            // Initialize logger
            this.logger = new Logger_1.Logger("DynamicAudioOutput", this.enableLogging || this.enableLoggingLifecycle, true);
        ...
        addAudioFrame(uint8Array, channels = 1) {
            ...
            const { data, shape } = this.convertPCM16ToAudFrameAndShape(uint8Array, channels);
