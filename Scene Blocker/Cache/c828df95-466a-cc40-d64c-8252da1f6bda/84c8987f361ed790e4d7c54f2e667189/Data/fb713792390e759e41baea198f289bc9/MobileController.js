...
let MobileController = (() => {
    ...
    var MobileController = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("MobileController", this.enableLogging || this.enableLoggingLifecycle, true);
        ...
        onStart() {
            ...
            const mobileInputData = SIK_1.SIK.MobileInputData;
