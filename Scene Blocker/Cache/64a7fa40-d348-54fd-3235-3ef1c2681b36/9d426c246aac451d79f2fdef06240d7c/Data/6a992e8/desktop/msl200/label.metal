...
//float AspectRatio 4384
//float outlineThickness 4388
//float4 boxColor 4400
//float4 outlineColor 4416
//float Port_objectWidth_N002 4432
//float depthRef 4436
//}
...
float Output_N1=0.0;
float param_1=(*sc_set0.UserUniforms).AspectRatio;
Output_N1=param_1;
float Output_N5=0.0;
float param_2=(*sc_set0.UserUniforms).outlineThickness;
Output_N5=param_2;
float4 Output_N3=float4(0.0);
float4 param_3=(*sc_set0.UserUniforms).boxColor;
Output_N3=param_3;
float4 Output_N6=float4(0.0);
float4 param_4=(*sc_set0.UserUniforms).outlineColor;
Output_N6=param_4;
float3 Position_N0=float3(0.0);
Position_N0=Globals.SurfacePosition_ObjectSpace;
float4 ResultColor_N2=float4(0.0);
float param_5=(*sc_set0.UserUniforms).Port_objectWidth_N002;
float param_6=Output_N1;
float param_7=Output_N5;
float4 param_8=Output_N3;
float4 param_9=Output_N6;
float3 param_10=Position_N0;
float4 param_11=float4(0.0);
N2_objectWidth=param_5;
N2_objectHeight=param_6;
N2_outlineThickness=param_7;
N2_boxColor=param_8;
N2_outlineColor=param_9;
N2_objPos=param_10;
float2 l9_1=float2(N2_objPos.x*N2_objectWidth,N2_objPos.y*N2_objectHeight);
float2 l9_2=float2(N2_objectWidth,N2_objectHeight)*0.5;
float l9_3=fast::min(N2_objectWidth,N2_objectHeight)*0.1;
float2 l9_4=l9_1;
float2 l9_5=l9_2;
float l9_6=l9_3;
float2 l9_7=abs(l9_4)-(l9_5-float2(l9_6));
float l9_8=(length(fast::max(l9_7,float2(0.0)))+fast::min(fast::max(l9_7.x,l9_7.y),0.0))-l9_6;
float l9_9=l9_8;
float l9_10=N2_objectWidth*N2_outlineThickness;
if (l9_9>0.0)
{
discard_fragment();
}
...
param_11=N2_ResultColor;
ResultColor_N2=param_11;
...
float4 l9_14=fast::max(param_13,float4(0.0));
float4 param_14=l9_14;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_17=fast::clamp(l9_16.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_17=fast::clamp(dot(l9_16.xyz,float3(l9_16.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_17=(1.0-dot(l9_16.xyz,float3(0.33333001)))*l9_16.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_17=(1.0-fast::clamp(dot(l9_16.xyz,float3(1.0)),0.0,1.0))*l9_16.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_17=fast::clamp(dot(l9_16.xyz,float3(1.0)),0.0,1.0)*l9_16.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_17=fast::clamp(dot(l9_16.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_17=dot(l9_16.xyz,float3(0.33333001))*l9_16.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_17=1.0-fast::clamp(dot(l9_16.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_18=l9_17;
float l9_19=l9_18;
float l9_20=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_19;
float3 l9_21=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_15.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_22=float4(l9_21.x,l9_21.y,l9_21.z,l9_20);
param_15=l9_22;
}
else
{
...
int l9_49=l9_44;
float2 l9_50=l9_42;
int l9_51=sc_ScreenTextureLayout_tmp;
int l9_52=l9_49;
float l9_53=l9_43;
float2 l9_54=l9_50;
int l9_55=l9_51;
...
float3 l9_58=l9_57;
float3 l9_59=l9_58;
float4 l9_60=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_59.xy,bias(l9_53));
float4 l9_61=l9_60;
float4 l9_62=l9_61;
l9_25=l9_62;
}
float4 l9_63=l9_25;
float3 l9_64=l9_63.xyz;
float3 l9_65=l9_64;
float3 l9_66=l9_23.xyz;
float3 l9_67=definedBlend(l9_65,l9_66,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_24=float4(l9_67.x,l9_67.y,l9_67.z,l9_24.w);
float3 l9_68=mix(l9_64,l9_24.xyz,float3(l9_23.w));
l9_24=float4(l9_68.x,l9_68.y,l9_68.z,l9_24.w);
l9_24.w=1.0;
float4 l9_69=l9_24;
param_15=l9_69;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_70=float4(in.varScreenPos.xyz,1.0);
param_15=l9_70;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_71=gl_FragCoord;
float l9_72=fast::clamp(abs(l9_71.z),0.0,1.0);
float4 l9_73=float4(l9_72,1.0-l9_72,1.0,1.0);
param_15=l9_73;
}
else
{
float4 l9_74=param_15;
...
float4 l9_81=param_17;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_81.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_81;
return out;
}
} // FRAGMENT SHADER
