...
export class BlockingGuideController extends BaseScriptComponent {
  ...
  @input
  @hint("First slide index that should map to waypoint 0 (intro slides come before this)")
  ...
  @input
  @hint("Additional vertical lift applied directly to final path (cm)")
  pathLift: number = 0
